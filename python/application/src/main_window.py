...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def createInputItemBox(self, inputItemEntry: TradeupInputEntry, inputItem: MarketItem, index: int):
        ...
        itemAdjustedFloatValLabel = widgets.createAdjustedFloatValLabel(inputItemEntry.adjustedFloatVal)
        ...
        rightBoxContents.layout().addWidget(itemAdjustedFloatValLabel)
    ...
    def createOutputItemBox(self, tradeup: Tradeup, outputItemEntry: TradeupOutputEntry, outputItem: MarketItem, index: int):
        ...
        itemAdjustedFloatValLabel = widgets.createAdjustedFloatValLabel(outputItemEntry.adjustedFloatVal)
